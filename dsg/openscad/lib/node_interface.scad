...
NODE_RECEIVER_LOWER_TRANSITION_LENGTH =
    detachable_interface_end_transition_length();
NODE_RECEIVER_LOWER_ACTIVE_LENGTH =
    detachable_interface_active_length();
NODE_RECEIVER_TOP_GUIDE_TRANSITION_LENGTH =
    detachable_interface_end_transition_length();
NODE_RECEIVER_TOP_GUIDE_ACTIVE_LENGTH =
    detachable_interface_active_length();
NODE_RECEIVER_TOP_GUIDE_LENGTH = NODE_RECEIVER_FUNCTIONAL_LENGTH;

// Tessellation only. The physical contract is the 1 mm smooth depth blend.
...
function _node_receiver_depth_factor(t) =
    detachable_interface_depth_factor(t);
