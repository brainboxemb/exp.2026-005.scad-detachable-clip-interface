...
module _node_positive_y_top_guide_transition() {
    ...
    // At the receiver end the inner edge is also outside the real x=5 face,
    // so the cut depth has reached zero while z0/z1 stay unchanged.
    xe = NODE_RECEIVER_WIDTH / 2 + 0.001;
