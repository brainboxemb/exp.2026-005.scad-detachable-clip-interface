...
| Phase | Duration |
| --- | ---: |
| Preflight + execution plan | 12.974 s |
| Cache restore | 3.148 s |
| Runtime pull | 27.987 s |
| Capability materialization | 67.816 s |
| Cache save | 1.415 s |
| Validation + finishing | 443 ms |
| Snapshot preparation | 11 ms |
| **Total to prepared snapshot** | **113.863 s** |
