...
| Phase | Duration |
| --- | ---: |
| Preflight + execution plan | 9.419 s |
| Cache restore | 1.115 s |
| Runtime pull | 19.212 s |
| Capability materialization | 97.160 s |
| Cache save | 50 ms |
| Validation + finishing | 396 ms |
| Snapshot preparation | 7 ms |
| **Total to prepared snapshot** | **127.427 s** |
