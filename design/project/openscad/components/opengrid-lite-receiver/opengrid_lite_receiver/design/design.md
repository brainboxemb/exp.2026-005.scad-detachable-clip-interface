...
![Full Source](img/01-full-source.png)
...
![Retained Top](img/02-retained-top.png)
...
![Retained Top Only](img/03-retained-top-only.png)
...
![Recentering Compare](img/04-recentering-compare.png)
...
![Recentered Compare](img/05-recentered-compare.png)
...
![Lite Result](img/06-lite-result.png)
...
![Solid Profile](img/07-solid-profile.png)
...
![Profile Zones](img/08-profile-zones.png)
...
![Flex Profile](img/09-flex-profile.png)
